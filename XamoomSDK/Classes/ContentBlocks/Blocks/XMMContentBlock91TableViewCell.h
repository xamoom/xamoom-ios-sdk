//
//  XMMContentBlock91TableViewCell.h
//  XamoomSDK
//
...
@interface XMMContentBlock91TableViewCell : UITableViewCell<MGLMapViewDelegate, CLLocationManagerDelegate>
...
@interface XMMContentBlock91TableViewCell (XMMTableViewRepresentation)
